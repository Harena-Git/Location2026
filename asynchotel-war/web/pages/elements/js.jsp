...
//        window.setInterval(getMessageDeploiement, 30000);
    ...
    function ouvrirModal(event,contentUrl,modalCible)
    {
        ...
        //alert("NIditra anaty ouvrir mdale");
        //var contentUrl = "http://www.ketrika.com"; // Exemple d'URL
        // On utilise fetch() pour obtenir le contenu du lien
        fetch(contentUrl)
            .then(response => response.text()) // On obtient le texte du lien (HTML ou autre contenu)
            .then(html => {
            ...
            .catch(error => {
                // Gérer les erreurs
                document.getElementById("modalContent").innerHTML = "Erreur de chargement du contenu.";
                var modal = new bootstrap.Modal(document.getElementById('linkModal'));
                modal.show();
            });
    }
