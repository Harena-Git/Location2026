        ...
        try {String nomTable = req.getParameter("nomTable");
            ...
            if(type.equals("noUser") || type.equals("aucun")) {
                ...
                if (type.equals("prevision")) {
                    ...
                    lien+="/station/pages/module.jsp?but=prevision/resultat-prevision.jsp&currentMenu=MENUDYN0020003&datyFiltre="+datyFiltre+"&datyDebut="+deb+"&datyFin="+fin+"&grouper="+grouper;
