...
public class FactureFournisseurDetailsCpl extends FactureFournisseurDetails implements ClassIA {
    ...
    public String getUrlListe() {
        return "/station/pages/module.jsp?but=facturefournisseur/facturefournisseur-liste.jsp&currentMenu=MNDN000000007";
    }
    @Override
    public String getUrlAnalyse() {
        return "/station/pages/module.jsp?but=facturefournisseur/achat-analyse.jsp";
    }
    @Override
    public String getUrlSaisie() {
        return "/station/pages/module.jsp?but=facturefournisseur/facturefournisseur-saisie.jsp&currentMenu=MNDN000000014";
    }
    @Override
