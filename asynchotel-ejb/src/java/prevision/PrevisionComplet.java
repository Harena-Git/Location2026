...
public class PrevisionComplet extends PrevisionCPL implements ClassIA {
    ...
    public String getUrlListe() {
        return "/station/pages/module.jsp?but=prevision/prevision-liste.jsp&currentMenu=MENUDYN0020002";
    }
    @Override
    public String getUrlAnalyse() {
        return "/station/pages/module.jsp?but=prevision/resultat-prevision.jsp&currentMenu=MENUDYN0020003";
    }
    @Override
    public String getUrlSaisie() {
        return "/station/pages/module.jsp?but=prevision/prevision-saisie.jsp&currentMenu=MENUDYN0020001";
    }
    @Override
