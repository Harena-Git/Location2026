...
public class FabricationFilleCpl2 extends FabricationFilleCpl implements ClassIA {
    ...
    public String getUrlListe() {
        return "/station/pages/module.jsp?but=fabrication/fabrication-liste.jsp&currentMenu=MENUDYN0304009";
    }
    @Override
    public String getUrlAnalyse() {
        return "/station/pages/module.jsp?but=fabrication/analyseFabrication-details.jsp";
    }
    @Override
