...
public class VenteDetailsLib  extends VenteDetails implements ClassIA {
    ...
    public String getUrlListe() {
        return "/station/pages/module.jsp?but=vente/vente-liste.jsp&currentMenu=MNDN000000007";
    }
    @Override
    public String getUrlAnalyse() {
        return "/station/pages/module.jsp?but=vente/vente-analyse.jsp&currentMenu=MNDN0000000111";
    }
    @Override
    public String getUrlSaisie() {
        return "/station/pages/module.jsp?but=vente/vente-saisie.jsp&currentMenu=MNDN000000006";
    }
    @Override
